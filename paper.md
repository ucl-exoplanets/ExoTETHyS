...
Scientific details of the algorithms and a comprehensive comparison to other relevant codes can be found in a companion paper (@2019arXiv190809599M, accepted by AJ). Technical usage details can be found on GitHub.
