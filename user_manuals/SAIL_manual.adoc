...
*passbands* (MANDATORY) +
values: built-in passband names if not passbands_path (various instrumental passbands, plus uniform passbands compatible with each stellar_models_grid) or user file names
