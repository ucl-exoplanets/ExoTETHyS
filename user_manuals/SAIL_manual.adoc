...
image::https://github.com/ucl-exoplanets/ExoTETHyS/blob/v2-beta/user_manuals/figures/rescaled_vs_claret4_intensities.png[width=40%],https://github.com/ucl-exoplanets/ExoTETHyS/blob/v2-beta/user_manuals/figures/rescaled_vs_original_intensities.png[width=40%]
