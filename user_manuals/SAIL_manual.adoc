...
```
After some restyling you could obtain this figure:

The neighbout intensities file contains the original mu values and the corresponding passband intensities:
[source, bash]
```
...
image::https://github.com/ucl-exoplanets/ExoTETHyS/blob/v2-beta/user_manuals/figures/rescaled_vs_claret4_intensities.png[width=40%, float=left]
image::https://github.com/ucl-exoplanets/ExoTETHyS/blob/v2-beta/user_manuals/figures/rescaled_vs_original_intensities.png[width=40%, float=right]
