...
<Quantity 0.00528299>
```
The 'eclipse_depth_average_in' denotes the average planetary flux that would be observed during the eclipse, if it was not occulted by the star:
[source, bash]
```
...
The depth corresponding to the pure nightside occultation is even higher:
